...
var studentSignup = function studentSignup(_x, _x2) {
  return (_ref =
    _ref ||
    _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(req, res) {
        var otp, student, tokenParams, token;
            ...
            while (1)
              switch ((_context.prev = _context.next)) {
                case 0:
                  ...
                  req.body.otp = otp;
                  _context.next = 5;
                  return _studentModel.Student.create(req.body);
                case 5:
...
var verifyOTP = function verifyOTP(_x3, _x4) {
  return (_ref2 =
    _ref2 ||
    _asyncToGenerator(
            ...
            while (1)
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  _context2.prev = 0;
                  _context2.next = 3;
                  return _studentModel.Student.findOne({
...
var studentLogin = function studentLogin(_x5, _x6) {
  return (_ref3 =
    _ref3 ||
    _asyncToGenerator(
            ...
            while (1)
              switch ((_context3.prev = _context3.next)) {
                case 0:
                  _context3.prev = 0;
                  _context3.next = 3;
                  return _studentModel.Student.findOne(req.body).select({
                    name: 1,
                    _id: 1,
                    phone: 1,
                    marks: 1,
...
var getAllStudents = function getAllStudents(_x7, _x8) {
  return (_ref4 =
    _ref4 ||
    _asyncToGenerator(
            ...
            while (1)
              switch ((_context4.prev = _context4.next)) {
                case 0:
                  _context4.prev = 0;
                  _context4.next = 3;
                  return _studentModel.Student.find({});
                case 3:
...
var getStudentById = function getStudentById(_x9, _x10) {
  return (_ref5 =
    _ref5 ||
    _asyncToGenerator(
...
var updateStudent = function updateStudent(_x11, _x12) {
  return (_ref6 =
    _ref6 ||
    _asyncToGenerator(
            ...
            while (1)
              switch ((_context6.prev = _context6.next)) {
                case 0:
                  _context6.prev = 0;
                  _context6.next = 3;
                  return _studentModel.Student.findById(
                    req.params.id,
                    req.body,
                    {
                      new: true,
...
var deleteStudent = function deleteStudent(_x13, _x14) {
  return (_ref7 =
    _ref7 ||
    _asyncToGenerator(
            ...
            while (1)
              switch ((_context7.prev = _context7.next)) {
                case 0:
                  _context7.prev = 0;
                  _context7.next = 3;
                  return _studentModel.Student.findByIdAndDelete(req.params.id);
                case 3:
                  deletedStudent = _context7.sent;
                  if (deletedStudent) {
                    _context7.next = 6;
                    break;
                  }
